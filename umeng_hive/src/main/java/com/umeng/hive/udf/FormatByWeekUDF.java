 ...
 * 按照天进行偏移量计算，格式化
 *   formatbyweek(-1)                                    取上周的yyyyMMdd
 *  formatbyweek(-1,'yyyy/MM/dd')                           取上周的yyyy/MM/dd
 *  formatbyweek(1548674636353 , -1 , 'yyyy/MM/dd')                 取指定周时间
 *  formatbyweek('2020-03-02', 'yyyy-MM-dd' , -1 , 'yyyy/MM/dd')    取指定周时间
 */
